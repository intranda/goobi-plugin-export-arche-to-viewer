...
public class ArcheToViewerExportPluginTest {
    ...
    public void testConstructor() {
        ArcheToViewerExportPlugin plugin = new ArcheToViewerExportPlugin();
        assertNotNull(plugin);
    }

    private XMLConfiguration getConfig() {
        String file = "plugin_intranda_export_arche_to_viewer.xml";
